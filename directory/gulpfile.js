...
var config = {
    ...
    pug: {
        locals: {
            styleSwitcher: false,
            restaurantsJson: JSON.parse(
                fs.readFileSync("./pug/js/restaurants-geojson.json", {
                    encoding: "utf8",
                })
            ),
            roomsJson: JSON.parse(
                fs.readFileSync("./pug/js/rooms-geojson.json", {
                    encoding: "utf8",
                })
            ),
            bookingsJson: JSON.parse(
                fs.readFileSync("./pug/js/bookings.json", {
                    encoding: "utf8",
                })
            ),
        },
